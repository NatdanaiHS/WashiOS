...
| `conceicao2025` | Journal PDF: https://jatm.com.br/jatm/article/download/1379/1044/6370 | Six-module MIL/SIL/HIL SATS process, test reuse, traceability, and FEM bus faults. |

The conservative gap statements use “among the closest published studies reviewed,” “we did not find,” and “not reported in the cited publication(s).” Each “not reported” statement is limited to the cited text and is not generalized to all prior work. No assertion was imported from an alternate manuscript draft.
