...
### Consolidated ICSEC submission readiness (2026-09-02T01:55:00+07:00)

- This was a read-only-evidence/manuscript milestone. No serial port was opened and no hardware was powered, reset, flashed, rewired, commanded, or observed. Starting branch/HEAD was synchronized `experiment/icsec-extension-20260830` / `6b7741edcafff19a78b47b5d304b5b989d360ddc`; the only starting modification was the Research Director's `NEXT_TASK.md`.
- `main`, `origin/main`, and `icsec-2026-evaluated-state` remain frozen at `8a47d070c549274c59cdbde2495afa8d353a93b3`. The original submission-safe PDF remains unchanged at SHA-256 `992A1C9AA41F4295BF7F97CA081D79A7DE2ABBB4B419B2A0B82144C1B50928DF`.
- The evidence-omission audit recovered the valid separate 605.0-s nominal observation into the manuscript without changing the primary N0 or 90-trial denominators. Its validation contains 121 ONLINE status records, strictly increasing `ok` 1760 to 2960, zero timeout/CRC/sequence/recovery deltas, and zero prohibited markers; evidence hash remains `3119D5994378E00C7ACE945B0FCB96CBA28C5855CDFEA445CD26570FD52A74FD`.
- The BAD_CRC source/raw trace now states the evaluated control flow and ordered markers: SHORT retained CRC rejection then timeout count one without OFFLINE before restoration; SUSTAINED retained CRC rejection, timeout counts one/two, OFFLINE at count three, then confirmed restoration and recovery. The known-limited derived `offline_before_restore` field is not used. `bad_crc_results.json` remains SHA-256 `F6332F913FFA91432032AA1E5582AE78378F8880FC22D11B921C5B793ADC4E90`; evaluated source revision is `cfd4b1b59d5018f498e5cc083ab27e1d230ae85d`.
- Claim corrections replace the stale whole-study one-pair statement and both cross-configuration headings. The candidate states one primary G431/G474 pair plus two separately analyzed physical F411 pairs under one fixed F411 configuration. No frozen empirical number, F411 denominator, latency definition, table III--V value, or scope interpretation changed.
- All six retained references were verified against Crossref DOI records. Official ICSEC/IEEE instructions were checked for 4--6 pages, IEEE conference format, and double-anonymous submission. No result or reference was imported from the AI-generated revised manuscript.
- Final candidate: `research/icsec2026/extension/submission_candidate_20260902/main.pdf`, five US-letter pages, SHA-256 `99E4180F4B172C1CC7BABFCF8BE92FCC5442B3868F7AAD1D32A13779849E765D`. Tectonic build completed with no fatal error, undefined citation/reference, or overfull box. All five 144-dpi page renders were visually inspected with no clipping, collision, broken table/reference, or anonymity defect.
- Deterministic validator status is PASS for frozen refs/hashes, nominal fields, BAD_CRC order, required manuscript claims, excluded wording, anonymity, and six DOI records. The first validator run failed before evidence access because its repository root was one parent too shallow; the failure is retained and the corrected rerun passed.
...
### Pre-cleanup FINAL_PASS protection freeze (2026-09-02)

- No cleanup, relocation, manuscript regeneration, evidence modification, or hardware action occurred. Freeze started from clean synchronized branch `experiment/icsec-extension-20260830` at `b6fd0a9813168fefe90168b61cd8fb26dae0a48b`; `origin/experiment/icsec-extension-20260830` matched. `main`, `origin/main`, and `icsec-2026-evaluated-state` remained frozen at `8a47d070c549274c59cdbde2495afa8d353a93b3`.
- Exact final PDF remains `research/icsec2026/extension/final_pass_submission_20260902/main.pdf`, five pages, SHA-256 `99E4180F4B172C1CC7BABFCF8BE92FCC5442B3868F7AAD1D32A13779849E765D`. Final manuscript sources and all candidate/frozen fallback paths are recorded in `research/icsec2026/cleanup_freeze_20260902/FREEZE_STATE.json`.
- The cleanup-protection record identifies six manuscript evidence packages: the frozen 90-trial campaign, pre/post N0 windows, separate 605-s/BAD_CRC extension package, and the two separate F411 campaigns. It records 18 provenance/table-generation/source dependencies, including both deterministic table generators, all retained generation attempts, readiness validation, evaluated source commit/blob identities, and the frozen primary provenance package.
- Protected repository manifest covers 906 tracked immutable-content files across the full ICSEC research tree and tracked `core`, `bootloader`, and `demo-payload` trees; mutable control records `SESSION_STATE.md` and `NEXT_TASK.md` are explicitly excluded. Protected bytes/tree SHA-256 are recorded as `9576D6D8E6653778D3E7B8FB369ABFFAF6F66C217260AF8B328347700A0F1B90`.
